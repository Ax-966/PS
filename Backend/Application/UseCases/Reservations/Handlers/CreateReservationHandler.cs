...
public class CreateReservationHandler : ICommandHandler<CreateReservation, Reservation>
{
    ...
    public CreateReservationHandler(  IReservationRepository reservationRepository, ISeatRepository  seatRepository, IAuditLogRepository  auditLogRepository, IUnitOfWork            unitOfWork)
    {
